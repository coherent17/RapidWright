...
public enum Series {
    // See https://www.xilinx.com/support/documentation/user_guides/ug470_7Series_Config.pdf Table
    // 5-24 See
    ...
    private Series(String regex, int blockTypeLSB, int blockTypeWidth, int topBotBit, int rowLSB, int rowWidth,
                   int colLSB, int colWidth, int minorLSB, int minorWidth, int cleHeight) {
