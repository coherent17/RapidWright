...
public enum TileTypeEnum {
    ...
    AMS_M12BUF_CTR_RIGHT_BOT_R_FT,
    AMS_M12BUF_CTR_RIGHT_TOP_L_FT,
    AMS_M12BUF_CTR_RIGHT_TOP_R_FT,
    ...
    CFG_M12BUF_CFG_LASSEN_IO_BOT_L_FT,
    CFG_M12BUF_CFG_LASSEN_IO_BOT_R_FT,
    CFG_M12BUF_CFG_LASSEN_IO_TOP_L_FT,
    CFG_M12BUF_CFG_LASSEN_IO_TOP_R_FT,
    CFG_M12BUF_CFG_LASSEN_M_BOT_L_FT,
    CFG_M12BUF_CFG_LASSEN_M_TOP_L_FT,
    CFG_M12BUF_CFG_LASSEN_TERM_ALL_L_FT,
    CFG_M12BUF_CFG_LASSEN_TERM_BOT_L_FT,
    CFG_M12BUF_CFG_LASSEN_TERM_BOT_R_FT,
    CFG_M12BUF_CFG_LASSEN_TERM_TOP_L_FT,
    CFG_M12BUF_CFG_LASSEN_TERM_TOP_R_FT,
    ...
    CFG_M12BUF_CTR_RIGHT_TOP_R_FT,
    CFG_M12BUF_HDIOL_L_FT,
    ...
    CFRM_CBRK_CTR_RIGHT_R_FT,
    CFRM_CBRK_HDIOL_L_FT,
    CFRM_CBRK_IO_L,
    CFRM_CBRK_IO_R,
    CFRM_CBRK_L,
    CFRM_CBRK_L_RBRK,
    ...
    CFRM_CPIPE_TERM_MMI_CORE,
    CFRM_CPIPE_TERM_PSXC_CORE,
    ...
    CLKE2_GT_ULVT_AAA_TILE,
    CLKE2_GT_ULVT_AAA_TILE_MY,
    CLKE2_GT_ULVT_BBA_TILE,
    CLKE2_GT_ULVT_BBA_TILE_MY,
    CLKE2_GT_ULVT_CCA_TILE,
    ...
    CLK_REBUF_HSR_ME_TNOC_ULVT_CORE,
    ...
    CPM_G5_TILE,
    CSEC_CONFIG_FT,
    CSEC_CONFIG_TERM_B_FT,
    CSEC_CONFIG_VER2_FT,
    CSEC_CONFIG_VER2_TERM_B_FT,
    DCMAC_TILE,
    DDRMC5C_DMC_CORE,
    DDRMC5C_DMC_CORE_MY,
    DDRMC5E_DMC_CORE,
    ...
    FSR_ISP_DUAL_GT_TILE,
    FSR_ISP_GTYP_OCTAL_GT_TILE,
    ...
    FSR_OCTAL_VR_REMAP_TILE,
    FSR_OCTAL_VR_REMAP_TILE_MY,
    FSR_QUAD_GT_TILE,
    FSR_QUAD_GT_TILE_MY,
    FSR_QUAD_NIC_TILE,
    FSR_QUAD_REMAP_TILE,
    FSR_QUAD_REMAP_TILE_MY,
    FSR_QUAD_VR_REMAP_TILE,
    FSR_QUAD_VR_REMAP_TILE_MY,
    FSR_VCU_GT_TILE,
    ...
    GTH_QUAD_RIGHT_TERM_R_FT,
    GTH_QUAD_RIGHT_TERM_R_RBRK_FT,
    GTH_QUAD_RIGHT_TERM_R_TERM_B_FT,
    ...
    HDIOLC_HDIOL_LEFT_FILL_RBRK_FT,
    HDIOLC_HDIOL_LEFT_RBRK_FT,
    HDIOLC_HDIOL_LEFT_TERM_B_FT,
    HDIOLC_HDIOL_RIGHT_TERM_B_FT,
    HDIOLC_HDIOL_RIGHT_TERM_RBRK_FT,
    HDIOLC_HDIOL_RIGHT_TERM_T_FT,
    ...
    HDIOLC_HDIOS_CMAC_BOT_LEFT_FT,
    HDIOLC_HDIOS_CMAC_TOP_LEFT_FT,
    HDIOLC_HDIOS_LEFT_CMAC_TERM_T_FT,
    HDIOLC_HDIOS_LEFT_RBRK_FT,
    HDIOLC_HDIOS_LEFT_TERM_B_FT,
    HDIOLC_HDIOS_LEFT_TERM_T_FT,
    HDIOLC_HDIOS_TOP_LEFT_AUX_FT,
    HDIOLC_HDIOS_TOP_LEFT_CFG_FT,
    HDIOLC_HDIOS_TOP_LEFT_FT,
    HDIOS_PCIE4_RBRK_FT,
    HDIO_AMS_RBRK,
    HDIO_BOT_RIGHT,
    HDIO_BOT_TILE,
    ...
    HPIO_GTH_FILL_FT,
    HPIO_GTH_QUAD_LASSEN_LEFT_RBRK_FT,
    ...
    HPIO_HDIOL_FILL_FT,
    HPIO_HDIOL_FILL_TERM_B_FT,
    HPIO_HDIOL_LEFT_RBRK_FT,
    ...
    INT_INTF_20_2_LEFT_TERM_GT_IO_RBRK_FT,
    INT_INTF_20_2_RIGHT_TERM_GT_FT,
    INT_INTF_20_2_RIGHT_TERM_GT_IO_RBRK_FT,
    INT_INTF_20_2_RIGHT_TERM_GT_TERM_B_FT,
    INT_INTF_L,
    ...
    INT_INTF_RIGHT_TERM_HDIO_RBRK_FT,
    INT_INTF_RIGHT_TERM_HDIO_TERM_B_FT,
    INT_INTF_RIGHT_TERM_HDIO_TERM_T_FT,
    ...
    INT_INTF_RIGHT_TERM_XP5IO_RBRK_FT,
    INT_INTF_RIGHT_TERM_XP5IO_TERM_T_FT,
    INT_INTF_R_PCIE4,
    ...
    L_TERM_INT_BRAM,
    MC2NPI_BOT_RIGHT_FT,
    MC2NPI_RIGHT_RBRK_FT,
    MC2NPI_RIGHT_TERM_T_FT,
    MC2NPI_TOP_RIGHT_FT,
    MISC_AMS_VNOC_4CH_CORE,
    MISC_BFRB_DECAP_CORE,
    MISC_CIDB_HFSR_CORE,
    MISC_CLK_REBUF_VERT_4CH_CORE,
    MISC_CLK_VERT_TO_HSR_4CH_CORE,
    MISC_CLK_VNOC_4CH_CORE,
    MISC_DAC_ADC_DECAP_CORE,
    MISC_GTYP_ISP_CORE,
    MISC_GT_REBUF_TILE,
    MISC_GT_REBUF_TILE_MY,
    MISC_ISP_DECAP2_CORE,
    MISC_ISP_DECAP_CORE,
    MISC_MMI_TIEOFF_CORE,
    ...
    PCIE3_RIGHT,
    PCIE3_TOP_RIGHT,
    PCIE4CE_HDIOS_FILL_LC_FT,
    PCIE4CE_HDIOS_FILL_LC_TERM_B_FT,
    PCIE4CE_PCIE4CE_FT,
    PCIE4C_PCIE4C_FT,
    ...
    RBRK_VCU_ISP_CORE,
    RBRK_VDU_CORE,
    RBRK_VNOC4CH_AAA_CORE,
    RBRK_VNOC4CH_BBA_CORE,
    RBRK_VNOC4CH_CCA_CORE,
    RBRK_VNOC4CH_DECAP_CORE,
    RBRK_VNOC_AAA_CORE,
    RBRK_VNOC_AAO_CORE,
    RBRK_VNOC_BBA_CORE,
    RBRK_VNOC_BBO_CORE,
    ...
    RCLK_CBRK_HB_L_CORE,
    RCLK_CBRK_HB_L_VR_CORE,
    RCLK_CBRK_HB_R_CORE,
    RCLK_CBRK_HB_R_VR_CORE,
    RCLK_CBRK_IO,
    ...
    RCLK_RCLK_CBRK_CTR_RIGHT_M12BUF_DL4T_R_FT,
    ...
    RCLK_RCLK_HDIOL_MRC_R_FT,
    RCLK_RCLK_HDIOL_R_FT,
    RCLK_RCLK_HDIOS_CMAC_L_FT,
    RCLK_RCLK_HDIOS_L_FT,
    ...
    RCLK_RCLK_INTF_20_2_RIGHT_TERM_GT_FT,
    ...
    RCLK_RCLK_INTF_LEFT_TERM_IO_DL3_FT,
    ...
    RCLK_RCLK_INTF_RIGHT_TERM_IO_DL4T_FT,
    ...
    RCLK_RCLK_MC2NPI_R_FT,
    RCLK_RCLK_PCIE4CE_HDIOS_FILL_LC_FT,
    RCLK_RCLK_URAM_INTF_L_FT,
    RCLK_RCLK_VH_TERM_L_FT,
    RCLK_RCLK_XIPHY_INNER_FT,
    RCLK_RCLK_XIPHY_TERM_L_FT,
    RCLK_RCLK_XIPHY_TERM_R_FT,
    RCLK_SDFEC_CORE,
    RCLK_TERM_L,
    RCLK_URAM_CORE,
    RCLK_URAM_CORE_MY,
    ...
    X5PHIOLP_RIGHT_RBRK_FT,
    X5PHIOLP_RIGHT_TERM_T_FT,
    X5PLLTOP_VPLL_WRP,
    ...
    XIPHY_XIPHY_TERM_LEFT_FT,
    XIPHY_XIPHY_TERM_LEFT_HDIOL_RBRK_FT,
    XIPHY_XIPHY_TERM_LEFT_RBRK_FT,
    XIPHY_XIPHY_TERM_LEFT_TERM_B_FT,
    XIPHY_XIPHY_TERM_RIGHT_FT,
    XIPHY_XIPHY_TERM_RIGHT_HDIOL_RBRK_FT,
    XIPHY_XIPHY_TERM_RIGHT_TERM_B_FT,
    XIPHY_XIPHY_TERM_RIGHT_TERM_T_FT,
    XPIO_MISC_CORE,
    XPIO_MISC_CORE_MX,
    XPIO_NIBBLE_SC,
    XPIO_NIBBLE_SC_MX,
