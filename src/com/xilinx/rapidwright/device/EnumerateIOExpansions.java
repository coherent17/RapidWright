...
public class EnumerateIOExpansions {
    ...
    static {
        ...
        IOStandard[] series7IOStandards = new IOStandard[] {
            IOStandard.DIFF_HSTL_I,   IOStandard.DIFF_HSTL_II,   IOStandard.DIFF_HSTL_I_18, IOStandard.DIFF_HSTL_II_18,
            IOStandard.DIFF_SSTL18_I, IOStandard.DIFF_SSTL18_II, IOStandard.DIFF_SSTL15,    IOStandard.DIFF_SSTL15_R,
            IOStandard.DIFF_SSTL135,  IOStandard.DIFF_SSTL135_R, IOStandard.DIFF_HSUL_12,   IOStandard.DIFF_MOBILE_DDR,
            IOStandard.BLVDS_25,      IOStandard.LVDS_25,        IOStandard.RSDS_25,        IOStandard.TMDS_33,
            IOStandard.MINI_LVDS_25,  IOStandard.PPDS_25,
        };
        ...
        diffIOMap.put(PartNameTools.getPart("xc7a35tcsg324-1"),
                      new Pair<Unisim[], IOStandard[]>(series7DiffIOs, series7IOStandards));
        diffIOMap.put(PartNameTools.getPart("xcku035-fbva676-1-c"),
                      new Pair<Unisim[], IOStandard[]>(ultrascaleDiffIOs, ultrascaleIOStandards));
        diffIOMap.put(PartNameTools.getPart("xczu2eg-sbva484-2-e"),
                      new Pair<Unisim[], IOStandard[]>(ultrascaleDiffIOs, ultrascaleIOStandards));
    }
    ...
    public static void main(String[] args) {
        ...
        for (Entry<Part, Pair<Unisim[], IOStandard[]>> e : diffIOMap.entrySet()) {
            ...
            String pkgPin = seriesName.equals("Series7") ? "D5" : (seriesName.equals("UltraScalePlus") ? "B2" : "D14");
            ...
            for (Unisim u : ios.getFirst()) {
                ...
                for (IOStandard iostd : ios.getSecond()) {
                    ...
                    lines.add("puts $fp \"" + seriesName + " " + iostd + " " + u +
                              " [get_property REF_NAME [get_cells inst]]\"");
                    lines.add("close $fp");
                    ...
                    for (int i = 0; i < ports.size(); i++) {
                        ...
                        if (port.isInput()) {
                            ...
                            lines.add("        ." + port.getName() + "(" + port.getName() + "_" + unisimName + ")" +
                                      lastComma);
                        }
                    }
                    lines.add("    );\n");
