...
public class CopyImplementation {
    ...
    private static void printHelp(OptionParser p) {
        ...
        System.out.println("Copies the placement and routing information from one or more cells in one design \n"
        ...
        OptionParser p = new OptionParser() {
            {
                ...
                acceptsAll(INST_MAPPINGS_OPTS,
                           "Instance name mappings to copy implementation, each "
                               + "mapping separated by a comma (',') and src and dst names separated by a "
                               + "colon (':') (src0:dst0,src1:dst1,...)")
                    .withRequiredArg();
            }
        };
