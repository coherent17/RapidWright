    ...
    public static void main(String[] args) throws IOException {
        if (args.length < 2 || args.length > 4) {
            ...
            System.out.println("   Example round trip test for a logical & physical netlist to start from a DCP,"
                               ...
                               + "\n\t2. <input>.roundtrip.edf - EDIF after being written/read from serialized "
                               + "format");
            return;
        }
        ...
        Design design = edifFileName == null ? Design.readCheckpoint(args[0], CodePerfTracker.SILENT)
