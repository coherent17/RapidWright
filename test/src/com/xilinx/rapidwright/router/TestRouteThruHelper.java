...
public class TestRouteThruHelper {
    ...
    @CsvSource({
        ...
        "CLEM_X9Y238/CLEM.CLE_CLE_M_SITE_0_H1->>CLE_CLE_M_SITE_0_H_O,true", // Technically, the
                                                                            // H6LUT and G6LUT are
                                                                            // used as GND sources
        "CLEM_X9Y238/CLEM.CLE_CLE_M_SITE_0_H6->>CLE_CLE_M_SITE_0_H_O,true", // for sinks outside the
                                                                            // site, so while the
                                                                            // PIP may be available,
                                                                            // its end node will not
                                                                            // be
        "CLEM_X9Y238/CLEM.CLE_CLE_M_SITE_0_F1->>CLE_CLE_M_SITE_0_F_O,true", // F6LUT is unoccupied
        ...
        "CLEL_R_X10Y239/CLEL_R.CLE_CLE_L_SITE_0_A2->>CLE_CLE_L_SITE_0_A_O,false", // A6LUT is used
                                                                                  // as a GND source
                                                                                  // for CARRY8.S0
        "CLEL_R_X10Y239/CLEL_R.CLE_CLE_L_SITE_0_A3->>CLE_CLE_L_SITE_0_A_O,false",
        "CLEL_R_X10Y239/CLEL_R.CLE_CLE_L_SITE_0_B4->>CLE_CLE_L_SITE_0_B_O,true", // B6LUT is not
                                                                                 // needed by
                                                                                 // CARRY8.S1
        "CLEL_R_X10Y239/CLEL_R.CLE_CLE_L_SITE_0_B5->>CLE_CLE_L_SITE_0_B_O,true",
    })
    public void
    testRouteThruPIPAvailable(String pipName, boolean expected) {
        ...
        Assertions.assertEquals(expected,
                                RouteThruHelper.isRouteThruPIPAvailable(design, pip.getStartWire(), pip.getEndWire()));

        Assertions.assertEquals(expected,
                                RouteThruHelper.isRouteThruPIPAvailable(design, pip.getStartNode(), pip.getEndNode()));
    }
}
