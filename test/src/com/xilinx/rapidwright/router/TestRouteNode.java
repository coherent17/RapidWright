...
public class TestRouteNode {
    ...
    @CsvSource({
        ...
        "RCLK_DSP_INTF_CLKBUF_L_X36Y629/CLK_HDISTR_R8,RCLK_DSP_INTF_CLKBUF_L_X36Y629/"
            + "CLK_HDISTR_L8,RCLK_DSP_INTF_CLKBUF_L_X36Y629/"
            + "RCLK_DSP_INTF_CLKBUF_L.CLK_HDISTR_L8<<->>CLK_HDISTR_R8,true",
        // Connecting east:
        //   node RCLK_DSP_INTF_CLKBUF_L_X36Y629/CLK_HDISTR_R8 ->
        //   node RCLK_DSP_INTF_CLKBUF_L_X59Y629/CLK_HDISTR_R8
        "RCLK_DSP_INTF_CLKBUF_L_X59Y629/CLK_HDISTR_L8,RCLK_DSP_INTF_CLKBUF_L_X59Y629/"
            + "CLK_HDISTR_R8,RCLK_DSP_INTF_CLKBUF_L_X59Y629/"
            + "RCLK_DSP_INTF_CLKBUF_L.CLK_HDISTR_L8<<->>CLK_HDISTR_R8,false",
    })
    public void
    testGetPIPsBackToSource(String srcWireName, String sinkWireName, String pipAsString, boolean isReversed) {
