 ...
 * The testcases in this class are auto-generated. The main function in this class is the entry
 * point for that.
 */
public class TestRelocateTile {
    ...
    private void testRelocateTile(Device device, String templateStr, String newAnchorStr, String oldAnchorStr,
        ...
        Assertions.assertSame(
            ...
            () -> "Relocating " + template + " with anchor move from " + oldAnchor + " to " + newAnchor);
    }
    ...
    public static Stream<Arguments> testUltrascale() {
        return Stream.of(Arguments.of("BRAM_X38Y175", "BRAM_X32Y270", "BRAM_X10Y65", null),
    ...
    public static Stream<Arguments> testVersal() {
        return Stream.of(
            ...
            Arguments.of("BRAM_ROCF_TR_TILE_X41Y172", "CLE_W_CORE_X100Y330", "CLE_W_CORE_X106Y294",
                         "BRAM_ROCF_BR_TILE_X35Y208"),
            ...
            Arguments.of("CLE_W_CORE_X105Y173", "BRAM_ROCF_TR_TILE_X81Y292", "BRAM_ROCF_BR_TILE_X81Y200",
                         "CLE_W_CORE_X105Y265"),
            Arguments.of("CLE_W_CORE_X33Y88", "BRAM_ROCF_TR_TILE_X87Y268", "BRAM_ROCF_BR_TILE_X87Y204",
                         "CLE_W_CORE_X33Y152"),
            Arguments.of("CLE_E_CORE_X67Y313", "BRAM_ROCF_BR_TILE_X41Y104", "BRAM_ROCF_BR_TILE_X64Y224",
                         "CLE_E_CORE_X44Y193"),
            Arguments.of("CLE_E_CORE_X45Y52", "BRAM_ROCF_TL_TILE_X42Y308", "BRAM_ROCF_TL_TILE_X65Y264",
                         "CLE_E_CORE_X22Y96"),
            Arguments.of("CLE_W_CORE_X49Y321", "BRAM_ROCF_TL_TILE_X42Y80", "BRAM_ROCF_TR_TILE_X58Y308",
                         "CLE_W_CORE_X33Y93"),
            Arguments.of("BRAM_ROCF_BR_TILE_X87Y12", "BRAM_ROCF_BR_TILE_X35Y204", "BRAM_ROCF_TR_TILE_X41Y304", null),
            Arguments.of("BRAM_ROCF_TL_TILE_X88Y48", "BRAM_ROCF_BR_TILE_X87Y44", "BRAM_ROCF_TR_TILE_X87Y84",
                         "BRAM_ROCF_BL_TILE_X88Y8"),
            Arguments.of("BRAM_ROCF_TR_TILE_X64Y296", "BRAM_ROCF_BR_TILE_X58Y12", "BRAM_ROCF_BR_TILE_X18Y36", null),
            Arguments.of("BRAM_ROCF_BR_TILE_X103Y140", "BRAM_ROCF_BR_TILE_X87Y28", "BRAM_ROCF_TR_TILE_X87Y84",
                         "BRAM_ROCF_TR_TILE_X103Y84"),
            Arguments.of("BRAM_ROCF_BL_TILE_X42Y132", "BRAM_ROCF_TR_TILE_X64Y292", "BRAM_ROCF_TR_TILE_X41Y164",
                         "BRAM_ROCF_TL_TILE_X65Y260"),
            Arguments.of("CLE_W_CORE_X25Y191", "BRAM_ROCF_BR_TILE_X87Y140", "BRAM_ROCF_BR_TILE_X64Y116",
                         "CLE_W_CORE_X48Y215"),
            Arguments.of("CLE_E_CORE_X95Y108", "BRAM_ROCF_BR_TILE_X18Y40", "BRAM_ROCF_TL_TILE_X88Y60",
                         "CLE_E_CORE_X25Y88"),
            Arguments.of("CLE_E_CORE_X72Y83", "BRAM_ROCF_TR_TILE_X87Y68", "BRAM_ROCF_BR_TILE_X58Y120",
                         "CLE_E_CORE_X101Y31"),
            Arguments.of("CLE_W_CORE_X22Y246", "BRAM_ROCF_BL_TILE_X88Y100", "BRAM_ROCF_TL_TILE_X88Y152",
                         "CLE_W_CORE_X22Y194"),
            Arguments.of("CLE_E_CORE_X45Y198", "BRAM_ROCF_TL_TILE_X42Y304", "BRAM_ROCF_TL_TILE_X42Y316",
                         "CLE_E_CORE_X45Y186"),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X55Y0", "BRAM_ROCF_BR_TILE_X81Y40", "BRAM_ROCF_TL_TILE_X65Y188",
                         null),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X101Y0", "BRAM_ROCF_TL_TILE_X42Y264", "BRAM_ROCF_TL_TILE_X88Y264",
                         "CLK_REBUF_BUFGS_HSR_CORE_X55Y0"),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X55Y0", "BRAM_ROCF_TR_TILE_X81Y64", "BRAM_ROCF_TL_TILE_X65Y292",
                         null),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X90Y0", "BRAM_ROCF_BR_TILE_X35Y136", "BRAM_ROCF_BR_TILE_X64Y192",
                         null),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X0Y0", "BRAM_ROCF_TR_TILE_X41Y244", "BRAM_ROCF_TR_TILE_X103Y72",
                         null),
            ...
            Arguments.of("BRAM_ROCF_TR_TILE_X58Y312", "CLE_W_CORE_X44Y105", "CLE_E_CORE_X67Y297",
                         "BRAM_ROCF_BR_TILE_X35Y120"),
            Arguments.of("BRAM_ROCF_BR_TILE_X18Y32", "CLE_W_CORE_X2Y291", "CLE_W_CORE_X65Y207", null),
            Arguments.of("BRAM_ROCF_TR_TILE_X103Y296", "CLE_W_CORE_X31Y149", "CLE_W_CORE_X53Y193",
                         "BRAM_ROCF_TR_TILE_X81Y252"),
            ...
            Arguments.of("CLE_E_CORE_X8Y202", "CLK_REBUF_BUFGS_HSR_CORE_X79Y0", "CLK_REBUF_BUFGS_HSR_CORE_X43Y0",
                         "CLE_E_CORE_X44Y202"),
            Arguments.of("CLE_E_CORE_X67Y184", "CLK_REBUF_BUFGS_HSR_CORE_X19Y0", "CLK_REBUF_BUFGS_HSR_CORE_X66Y0",
                         "CLE_E_CORE_X20Y184"),
            Arguments.of("CLE_E_CORE_X51Y322", "CLK_REBUF_BUFGS_HSR_CORE_X66Y0", "CLK_REBUF_BUFGS_HSR_CORE_X101Y0",
                         "CLE_E_CORE_X16Y322"),
            Arguments.of("CLE_W_CORE_X105Y280", "CLK_REBUF_BUFGS_HSR_CORE_1_X0Y0", "CLK_REBUF_BUFGS_HSR_CORE_1_X0Y0",
                         "CLE_W_CORE_X105Y280"),
            Arguments.of("CLE_W_CORE_X77Y55", "CLK_REBUF_BUFGS_HSR_CORE_X19Y0", "CLK_REBUF_BUFGS_HSR_CORE_1_X0Y0",
                         "CLE_W_CORE_X96Y55"),
            Arguments.of("BRAM_ROCF_TR_TILE_X103Y160", "CLK_REBUF_BUFGS_HSR_CORE_X101Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_1_X0Y0", null),
            Arguments.of("BRAM_ROCF_TR_TILE_X35Y188", "CLK_REBUF_BUFGS_HSR_CORE_X43Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X112Y0", null),
            Arguments.of("BRAM_ROCF_TR_TILE_X18Y244", "CLK_REBUF_BUFGS_HSR_CORE_X31Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X19Y0", null),
            Arguments.of("BRAM_ROCF_BL_TILE_X88Y200", "CLK_REBUF_BUFGS_HSR_CORE_X66Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X66Y0", "BRAM_ROCF_BL_TILE_X88Y200"),
            Arguments.of("BRAM_ROCF_TR_TILE_X87Y332", "CLK_REBUF_BUFGS_HSR_CORE_X66Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X112Y0", "BRAM_ROCF_TR_TILE_X41Y332"),
            Arguments.of("CLE_E_CORE_X29Y112", "CLK_REBUF_BUFGS_HSR_CORE_X8Y0", "CLK_REBUF_BUFGS_HSR_CORE_X8Y0",
                         "CLE_E_CORE_X29Y112"),
            Arguments.of("CLE_W_CORE_X100Y303", "CLK_REBUF_BUFGS_HSR_CORE_X19Y0", "CLK_REBUF_BUFGS_HSR_CORE_X112Y0",
                         "CLE_W_CORE_X7Y303"),
            Arguments.of("CLE_E_CORE_X83Y185", "CLK_REBUF_BUFGS_HSR_CORE_X8Y0", "CLK_REBUF_BUFGS_HSR_CORE_X31Y0",
                         "CLE_E_CORE_X60Y185"),
            Arguments.of("CLE_W_CORE_X30Y44", "CLK_REBUF_BUFGS_HSR_CORE_X43Y0", "CLK_REBUF_BUFGS_HSR_CORE_X0Y0",
                         "CLE_W_CORE_X73Y44"),
            Arguments.of("CLE_W_CORE_X11Y314", "CLK_REBUF_BUFGS_HSR_CORE_X79Y0", "CLK_REBUF_BUFGS_HSR_CORE_X90Y0",
                         "CLE_W_CORE_X0Y314"),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X112Y0", "CLK_REBUF_BUFGS_HSR_CORE_X0Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X43Y0", null),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X43Y0", "CLK_REBUF_BUFGS_HSR_CORE_X19Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X43Y0", "CLK_REBUF_BUFGS_HSR_CORE_X19Y0"),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X8Y0", "CLK_REBUF_BUFGS_HSR_CORE_1_X0Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X0Y0", "CLK_REBUF_BUFGS_HSR_CORE_X8Y0"),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_X66Y0", "CLK_REBUF_BUFGS_HSR_CORE_X112Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X112Y0", "CLK_REBUF_BUFGS_HSR_CORE_X66Y0"),
            Arguments.of("CLK_REBUF_BUFGS_HSR_CORE_1_X0Y0", "CLK_REBUF_BUFGS_HSR_CORE_X43Y0",
                         "CLK_REBUF_BUFGS_HSR_CORE_X55Y0", null));
    }
    ...
    private static void generateTestcases(Device device) {
        ...
        Stream<String> testcases = randomTilesByType.stream().flatMap(
            anchorIter -> randomTilesByType.stream().flatMap(templateIter -> IntStream.range(0, 5).mapToObj(i -> {
                while (true) {
                    ...
                    if (result != null || rnd.nextDouble() < 0.05) {
                        return "\tArguments.of(" + getTileStr(template) + ", " + getTileStr(newAnchor) + ", " +
                            getTileStr(oldAnchor) + ", " + getTileStr(result) + ")";
                    }
                }
            })));
